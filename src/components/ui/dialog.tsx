...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "dialog-content-motion fixed left-1/2 top-1/2 z-50 grid w-[calc(100%-2rem)] max-w-lg gap-5 rounded-[28px] border border-outline-variant bg-surface-container-high p-6 text-on-surface shadow-m3-3 data-[state=open]:animate-dialog-in",
        className,
      )}
      {...props}
    >
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn("text-xl font-medium leading-none", className)} {...props} />
));
